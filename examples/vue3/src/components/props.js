...
export const props = [

  {
    ...
    lineWidth: 1,
    lineColor: '#fff',
    image: new URL('./img/example-0-image.svg', import.meta.url).href,
    overlayImage: new URL('./img/example-0-overlay.svg', import.meta.url).href,
    items: [
      {
        label: 'TWISTS',
      },
...

  {
    ...
    lineWidth: 0,
    overlayImage: new URL('./img/example-1-overlay.svg', import.meta.url).href,
    borderWidth: 0,
    items: [
      {
        label: 'Japanese',
...

  {
    ...
    lineWidth: 0,
    overlayImage: new URL('./img/example-2-overlay.svg', import.meta.url).href,
    items: [
      {
        label: 'Action',
      },
...

  {
    ...
    lineWidth: 1,
    lineColor: '#000',
    overlayImage: new URL('./img/example-3-overlay.svg', import.meta.url).href,
    items: [
      {
        label: '$ 50',
      },
...

  {
    ...
    rotationResistance: -100,
    image: new URL('./img/example-4-image.svg', import.meta.url).href,
    lineWidth: 0,
    items: [
      {
        label: 'SHELDON',
...

  {
    ...
    items: [
      {
        image: new URL('./img/example-5-item-0.svg', import.meta.url).href,
        imageRadius: 0.6,
        imageScale: 1.2,
      },
      {
        image: new URL('./img/example-5-item-1.svg', import.meta.url).href,
        imageRadius: 0.6,
        imageScale: 1.2,
      },
      {
        image: new URL('./img/example-5-item-2.svg', import.meta.url).href,
        imageRadius: 0.6,
        imageScale: 1.2,
      },
      {
        image: new URL('./img/example-5-item-3.svg', import.meta.url).href,
        imageRadius: 0.6,
        imageScale: 1.2,
      },
      {
        image: new URL('./img/example-5-item-4.svg', import.meta.url).href,
        imageRadius: 0.6,
        imageScale: 1.2,
      },
    ],
